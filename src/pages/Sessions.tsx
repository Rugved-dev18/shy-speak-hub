      ...
      <div className="animate-fade-up">
        <div className="flex items-center justify-between">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle className="font-display">Create a Session</DialogTitle>
              </DialogHeader>
              <div className="space-y-4 mt-4">
                ...
                <Button onClick={createSession} disabled={!title.trim() || !mentorName.trim()} className="w-full gradient-primary border-0 text-primary-foreground">Create</Button>
              </div>
            </DialogContent>
          </Dialog>
        </div>
